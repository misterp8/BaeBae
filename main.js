...
function playWoodSound(v) {
    ...
    g.gain.setValueAtTime(Math.min(v * 0.5, 1.0), t); g.gain.exponentialRampToValueAtTime(0.01, t + 0.15); o.connect(g); g.connect(audioCtx.destination); o.start(t); o.stop(t + 0.15);
}
